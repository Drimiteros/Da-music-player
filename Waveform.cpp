...
void Waveform::waveform_logic(Music& music, SoundBuffer& soundBuffer, int theme, float background_color[4][3], bool& view_waveform) {
        ...
        if (soundBuffer.getSampleCount() > 0 && music.getStatus() != Sound::Stopped) {
            ...
            for (size_t i = 0; i < 995; ++i) {
                ...
                if (sampleIndex < sample_count) {
                    ...
                    waveform[i].color = Color(background_color[theme][0], background_color[theme][1], background_color[theme][2]);
                }
                else {
...
void Waveform::draw(RenderWindow& window, bool& view_waveform) {
